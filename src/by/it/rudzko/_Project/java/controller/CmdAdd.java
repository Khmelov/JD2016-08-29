...
class CmdAdd extends Action{
    ...
    Action execute(HttpServletRequest req) {
        ...
        if (aud.isEmpty()) {
            Audience a1=new Audience ("Adult"); aud.add(a1); dao.audDao.create(a1);
            Audience a2=new Audience ("Men"); aud.add(a2); dao.audDao.create(a2);
            Audience a3=new Audience ("Women"); aud.add(a3); dao.audDao.create(a3);
            Audience a4=new Audience ("Teens"); aud.add(a4); dao.audDao.create(a4);
            Audience a5=new Audience ("Children"); aud.add(a5); dao.audDao.create(a5);
        }
