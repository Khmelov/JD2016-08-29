...
public class Main {
    ...
    public static void main(String[] args) {
        String[] tasks = new String[] {"2.1/0", "10/4", "a=0", "bb=15.7", "2.2*0", "3.0+0", "6.8-0",
        ...
        Calc c = Calc.restoreCalc("backup.txt"); // do not worry, there will be new hashmap if file is not found
