...
public class User {
    ...
    public String toString() {
        return String.format("{'id': %s, 'login': '%s', 'password': '%s', 'email': '%s', 'idRole': %s, " +
                "'firstName': '%s', 'lastName': '%s', 'middleName': '%s', 'dateOfBirth': '%s', 'idSex': '%s', " +
                "'passport': '%s', 'idAddress': %s,'idDriverLicense': '%s'}",
