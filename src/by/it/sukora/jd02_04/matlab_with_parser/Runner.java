...
import by.it.sukora.jd02_04.matlab_with_parser.tests.TestParser;
import by.it.sukora.jd02_04.matlab_with_parser.vars.Var;
import by.it.sukora.jd02_04.matlab_with_parser.vars.VarF;
import by.it.sukora.jd02_04.matlab_with_parser.vars.VarV;
...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        printOneVar(new TestParser.VarM("").add(new VarV(vec)));
        printOneVar(new TestParser.VarM("").sub(new VarV(vec)));
        printOneVar(new TestParser.VarM("").mul(new VarV(vec)));
        printOneVar(new TestParser.VarM("").div(new VarV(vec)));
