...
public class Main {
    ...
    public static void main(String[] args) {
        String[] taskA = new String[] {"3.8+26.2", "87.4-23.1", "1.04*5.9", "12.7*5", "-6+12", "-7*3.1", "-4/8", "-9-0.9"};
        String[] taskB = new String[] {"{2,3,4}*2", "{2,3,4}/3", "{2,3,4}-5", "-4+{2,3,4}", "{2,3,4}+{5,6,7}", "{2,3,4}-{5,6,7}"};
        String[] taskC = new String[] {"{{1,2},{8,3}}-2", "{{1,2},{8,3}}*{1,2}", "{{1,2},{8,3}}*{{1,2},{8,3}}", "{{1,2},{8,3}}+{{1,2},{8,3}}"};
        Calc c = new Calc();
