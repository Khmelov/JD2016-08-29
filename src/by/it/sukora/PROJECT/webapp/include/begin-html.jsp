        ...
        <div class="container-fluid">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    <menu:li command="CreateAd" text="Записаться на приём"/>
                    <menu:li command="ShowUsers" text="Посетители"/>
                </ul>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise><menu:li command="Profile" text="Мед карточка"/></c:otherwise>
                    </c:choose>
