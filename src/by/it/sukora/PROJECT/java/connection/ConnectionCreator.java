package by.it.sukora.PROJECT.java.connection;
...
public class ConnectionCreator {
    ...
    private static final String URL_DB =
            "jdbc:mysql://127.0.0.1:2016/test_hospital"
    ...
    public static Connection getConnection2() {
        ...
        try {
            ...
            DataSource ds = (DataSource) ic.lookup("java:/comp/env/jdbc/test_hospital");
