...
//        System.out.printf("create ticket: %s\n,%s\n", role ,role1);
        ...
        Bags bags = new Bags(2, 3, 6, 8);
        dao.getBagsDAO().create(bags);
        //dao.getBagsDAO().read(1);
        System.out.printf("Bags N: %d, user N: %d, ticket: %d, n_flight: %d;", bags.getIdBag(), bags.getUser(), bags.getN_flight(), bags.getTicket());
