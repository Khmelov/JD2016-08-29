...
public class Runner {
    public static void main(String[]args)
    {
        ...
        System.out.printf("%-8.4f%n", by.it.artiuschik.jd_01_05.Task2.calculateFunction(a,b));
        //Task3
        ...
        by.it.artiuschik.jd_01_05.Util.printArray(mas[1]);
        System.out.print("Значения функции y:   ");
        by.it.artiuschik.jd_01_05.Util.printArray(mas[0]);
        //Task6
        System.out.println("Задание №6");
        double [] function= by.it.artiuschik.jd_01_05.Task6.functionValues(-1.2,2.0);
        by.it.artiuschik.jd_01_05.Util.printArray(function,"arcsinArr",4);
        System.out.println("Нечетные элементы массива:");
        by.it.artiuschik.jd_01_05.Task6.printOddElements(function,"arcsinArr");
        System.out.println("Среднее геометрическое нечетных элементов: "+ Task6.srednGeom(function));
        //Task7
        System.out.println("Задание №7");
        double[] K= by.it.artiuschik.jd_01_05.Task7.function()[0];
        double[] T= Task7.function()[1];
        int colsK= by.it.artiuschik.jd_01_05.Util.sizeOfTable(K)[1];
        int colsT= by.it.artiuschik.jd_01_05.Util.sizeOfTable(T)[1];
        System.out.println("<Matrix K index to rows>");
        by.it.artiuschik.jd_01_05.Util.printMatrixCols(colsK,"K", K,false);
